...
```bash
git clone https://github.com/Emotionvonsignify/recomby-geo-221.git
cd recomby-geo-221
python setup.py
```
...
| Skill | 来源 | 用途 |
|-------|------|------|
| `seo-geo-optimizer` | [199-biotechnologies](https://github.com/Emotionvonsignify/recomby-geo-221) (MIT) | 主力，13 个 Python 脚本 |
...
<!-- Last updated: 2026-06-06 14:48:59 -->
